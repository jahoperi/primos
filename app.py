...
st.subheader('')
st.subheader('A1 = {[p, p + 2] que pertenecen al conjunto 2W | es el caso (i)}')
st.subheader('A2 = {[p, r] que pertenecen al conjunto 2W | es el caso (ii)}')
st.subheader('A3 = {[r, p] que pertenecen al conjunto 2W | es el caso (iii)}')
st.subheader('A4 = {[s, s + 2] que pertenecen al conjunto 2W | es el caso (iv)}')
st.subheader('A5 = {[t, t + 2] que pertenecen al conjunto 2W | es el caso (v)}')
st.subheader('')
...
st.subheader('faltan en el conjunto A4 los números: 68, 100')
st.subheader('')
st.subheader('A4 = {52, 68 = 33 + 35, 100 = 49 + 51} Nota: para tapar hasta 102 nada más')
st.subheader('')
